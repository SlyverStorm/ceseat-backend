...
export async function getOrder(
    ...
    return OrderModel.findOne({...query, deletedAt: null}, {}, options).populate(["orderStatus", "driver"]);;
}
...
export async function getAllOrders(
    ...
    return OrderModel.find({...query, deletedAt: null}, {}, options).populate(["orderStatus", "driver"]);;
}
...
export async function updateOrder(
    ...
    return OrderModel.findOneAndUpdate({...query, deletedAt: null}, update, options).populate(["orderStatus", "driver"]);;
}
