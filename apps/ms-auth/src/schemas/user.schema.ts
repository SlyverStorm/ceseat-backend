...
const createUserPayload = {
    body: object({
        ...
        refererCode: string().min(8, "Le code de parainage être composé de 8 caractères").max(8, "Le code de parainage être composé de 8 caractères").regex(refererCodeRegExp).optional()
    }).strict()
};
